...
const mirrorUrl = 'farst-core.gitee.io'
const isMirrorUrl = () => {
  if (!isClient) return
...
const resourceUrl = {
  ...
  gitee: {
    sketch:
      'https://gitee.com/farst-core/resources/raw/master/Element_Plus_Design_System_2022_1.0_Beta.zip',
    axure:
      'https://gitee.com/farst-core/resources/raw/master/Element_Components_v2.1.0.rplib',
  },
